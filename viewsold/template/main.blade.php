...
<body class="">
  ...
  <script src="{{asset('admin/assets/js/material-dashboard.js?v=2.1.2')}}"
         type="text/javascript"></script>
  <!-- Material Dashboard DEMO methods, don't include it in your project! -->
  <script src="{{asset('admin/assets/demo/demo.js')}}"></script>

  <script type="text/javascript" src="{{asset('admin/assets/js/master.js')}}"></script>
 
  <script>
    $(document).ready(function() {
      // Javascript method's body can be found {{asset('admin assets/js/demos.js
